...
const ProfileHeader = ({
  ...
  style={{background:"#f7fcff",
    // backgroundImage: `url('/images/backgimg.jpg')`,
...
>
    ...
    <div className="relative h-72 md:h-96 bg-red overflow-hidden">
    <img
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10">
        <div className="flex flex-col md:flex-row items-center md:items-end md:space-x-5 " style={{marginTop:"-5rem"}}>
          ...
          <div className="mt-4 mdLmt-0 text-center md:text-left flex-grow">
            <h1 className="text-3xl font-bold"  style={{marginTop:"-7rem"}}>{profileData?.username}</h1>
