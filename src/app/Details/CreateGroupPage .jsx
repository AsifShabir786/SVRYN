...
const CreateGroupPage = (props) => {
  ...
  console.log(message1, "Message from child:___");
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50 overflow-scroll ">
          <div
