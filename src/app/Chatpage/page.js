...
const Chatpage = () => {
 ...
 <div className="flex flex-col min-h-screen bg-background text-foreground">
  <main className="flex flex-1  ">
    ...
    {/* Page Content */}
    <div className="flex-1 w-full px-4 py-6 mx-auto md:ml-80 lg:mr-80 lg:max-w-5xl xl:max-w-6xl overflow-auto">
      <div className="flex flex-col lg:flex-row gap-6 border-4 border-[#d3c19a] p-4 rounded-xl shadow mt-6 w-full">
        {/* Left: Online Users */}
        <div className="lg:w-1/2 w-full">
          <h3 className="text-lg font-semibold mb-4">Online Connections</h3>
          <ul className="space-y-2 overflow-y-auto max-h-[680px] pr-1">
        ...
        <div className="lg:w-1/2 w-full">
          {showChatModal && selectedUser && (
            <div className="bg-white rounded-lg shadow-lg border border-gray-200 flex flex-col h-[680px]">
              {/* Header */}
