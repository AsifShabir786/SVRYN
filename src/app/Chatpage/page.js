  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground ">
      <main className="flex flex-1 pt-16">
        ...
        >
          <div
            className="lg:ml-2 xl:ml-28 flex border-4 p-4 border-[#d3c19a] rounded-xl shadow"
          ...
          >
            ...
            <div style={{ width: "50%" }}>
              {showChatModal && selectedUser && (
                <div
                  className="bg-white rounded-lg shadow-lg border border-gray-200 flex flex-col h-[680px]"
