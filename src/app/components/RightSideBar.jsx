...
const RightSideBar = () => {
  ...
  return (
    <div
      className="w-[500px] h-auto   border-r border-gray-300 p-4 flex flex-col justify-between"
      style={{ width: "auto" }}
    >
      <div>
        {/* LIGHT FORMS SECTION */}
        ...
        {/* TRANSMISSIONS */}
        <div
          className="mt-6 border-t border-yellow-700 pt-3 pl-3 flex justify-center items-center space-x-2   font-semibold text-sm tracking-widest"
          style={{ color: "#b79f68" }}
        >
          <Image
